...
//set state to empty user
    ...
    handleSignIn = async () => {
        const signIn = await request.post(`https://mysterious-reef-99737.herokuapp.com/api/auth/signin`, {
    ...
    handleSignUp = async () => {
        const signUp = await request.post(`https://mysterious-reef-99737.herokuapp.com/api/auth/signup`, {
